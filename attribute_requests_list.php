...
$sel="UPDATE registration set status=2 WHERE id='".$_GET['id']."'";

$res=mysqli_query($con,$sel);

echo "<script>alert('requested send to CA');location.href='attribute_requests_list.php'</script>";
...
$sel="SELECT * FROM registration WHERE status=1";
...
<a class="btn-lg btn-danger" href="attribute_requests_list.php?id=<?php echo $fetch['id'];?>&act=FORWARD" onclick="if(!confirm('Are you sure you want to forward.')) return false;" style="width: 40px">
                    Forward To CA
       </a>
</td>
<tr>
